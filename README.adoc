...
Existem diferentes maneiras de usar este template, pelo [Overleaf neste link aqui](https://www.overleaf.com/latex/templates/ft-unb-latex-template/rchggqhsxgjy), ou diretamente no seu computador.

Neste último caso, são necessários alguns softwares instalados em seu sistema operacional.

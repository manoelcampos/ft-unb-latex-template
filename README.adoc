...
pass:[<p align="center"><a href="https://github.com/manoelcampos/ft-unb-latex-template/blob/gh-pages/principal.pdf"><img src="imagens/exemplo.png"></a></p>]
...
== Exemplo
Um PDF de uma dissertação de exemplo utilizando o template https://github.com/manoelcampos/ft-unb-latex-template/blob/gh-pages/principal.pdf[é disponibilizado aqui].
